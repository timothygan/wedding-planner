...
1. **Read the PR description template:**
   ...
   - If it doesn't exist, inform the user that their `weddingplanner thoughts` setup is incomplete and they need to create a PR description template at `thoughts/shared/pr_description.md`
...
8. **Save and sync the description:**
   ...
   - Run `weddingplanner thoughts sync` to sync the thoughts directory
