...
3. **Set up the remote and worktree**:
   ...
   - If not, add it: `git remote add USERNAME git@github.com:USERNAME/wedding-planner`
   - Fetch from the remote: `git fetch USERNAME`
   - Create worktree: `git worktree add -b BRANCHNAME ~/wt/wedding-planner/SHORT_NAME USERNAME/BRANCHNAME`
...
4. **Configure the worktree**:
   ...
   - Initialize thoughts: `cd WORKTREE && weddingplanner thoughts init --directory wedding-planner`
...
- Create worktree at `~/wt/wedding-planner/eng-1696`
